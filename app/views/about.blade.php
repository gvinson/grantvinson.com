...
@section('content')
	...
	<div class="grid">
		...
		<div class="col-10 right">
			<h1>How do you do,</h1>
			<p><b>The name's Grant Vinson and I'm a front end and user experience developer currently located in Oklahoma City, OK.</b></p>
			<p>Peoples' experiences on the web are what keep me motivated. Is this click area to close to this other click area? How does this font render on retina devices? Why is this page taking more than 2 seconds to load? These are the questions that make coffee mandatory.</p>
